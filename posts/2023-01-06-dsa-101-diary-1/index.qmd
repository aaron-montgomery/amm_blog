...
format:
  html:
    ...
    fig-height: 6
    fig-align: 'center'
description: "Lessons from the first offering of the class"
...
| ![](dataquest.png) |
|:--:|
| <font size = "2"> <a href="https://www.dataquest.io/">dataquest.io</a> </font>|
...
![Dataquest Screenshot](dataquest_screenshot.png)
...
![Dataquest Screenshot](dataquest_screenshot_3.png)
...
I really can't say enough good things about Dataquest and my experience using it in my class. Whether you're someone looking to learn some data and programming concepts, or you're an instructor looking to provide some structured assistance for students, [Dataquest](https://www.dataquest.io) is worth checking out. (There's a free trial available if you want to give it a shot!)